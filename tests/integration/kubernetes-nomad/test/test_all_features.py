...
def test_all_features_integration(nomad_client, k8s_api_client):
    ...
    # Check labels for OPA policy enforcemen
    ...
    # Check resource limits for GPU suppor
    ...
    # If using GPUs, should have GPU limi
    ...
    security_context = container.security_contex
    assert security_context is not None, "Security context missing - OPA policy integration issue"
    assert security_context.run_as_non_root, "run_as_non_root should be True - OPA policy integration issue"
